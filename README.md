...
```
├── financial_pca.ipynb          # Main analysis notebook
...
### Time Series Forecasting (Procter & Gamble)
- Used **PG** (longest continuous DJIA member, since 1932) on monthly prices
...
- **Market integration is moderate**: PC1 explains ~34% of variance, but ~20 PCs are needed for 95% — diversification within the DJIA is meaningful.
...
```bash
# Clone the repo
git clone https://github.com/ChristianByabushi/data-applied-machine-learning.git
cd data-applied-machine-learning

# Install dependencies
pip install yfinance pandas numpy scikit-learn scipy statsmodels matplotlib seaborn

# Launch notebook
jupyter notebook financial_pca.ipynb
```
